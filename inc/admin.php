		...
		<form method="post" action="options.php">
			...
			<table>
				...
				<tr>
					...
					<?php else:?>
					<td><input class="<?php echo $data["class"]; ?>" id="cwlsm_settings[<?php echo $name; ?>]" size="45" name="cwlsm_settings[<?php echo $name; ?>]" type="text" value="<?php if(empty($cwlsm_options[$name])){echo $data["default"]; }else{ echo $cwlsm_options[$name];} ?>" placeholder="<?php echo $data["placeholder"]; ?>"/>
					<?php endif;?>

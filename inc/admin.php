	...
	<div class="wrap">
		...
		<form method="post" action="options.php">
			...
			<table>
				...
				<tr><td></td><td>Hey Rate this Plugin <a href="http://wordpress.org/extend/plugins/login-screen-manager/">here</a> and visit my Website <a href="http://www.codingwar.com/">CodingWar.com</a></td></tr>
				<tr>
					<td></td>
